...
//    private final Log expectedLog = new Log(expectedLogId, 1L, Level.from(0), LogData.from("Test log data"),
...
//            // Act
//            Log actualResult = asyncLogRepository.findById(expectedLogId);
//            // Assert
//            assertAll(
